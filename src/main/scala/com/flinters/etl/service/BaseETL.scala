...
import com.flinters.etl.model.{FileDataExtract, FileDataTransform, FileInfo}
import com.flinters.etl.repository.FileSystemRepository.FSRepository
import com.flinters.etl.repository.MySQLRepository.MediaSettingDao
...
abstract class BaseETL(fsRepository: FSRepository) {
  ...
  def load(fileInfo: FileInfo, filteredFilePath: String, filteredData: FileDataTransform, outputPath: Path, outputData: FileDataTransform): Unit
